...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		int length = str.length(); // see tech elevator book objects
		String word = str.substring(length - 2);
	...
	public String nonStart(String a, String b) {
		...
		return a.substring(1, lengthA) + b.substring(1, lengthB);
	}
	...
	public String middleTwo(String str) {
		...
		int length = str.length() / 2; // length is already divided by 2. I do not need to divide by 2 again in the
										// return statement
	...
	public String nTwice(String str, int n) {
		// first char 0 and length - n for last
	 ...
	 */
	public String twoChar(String str, int index) { // cant figure this one out
	...
	public boolean hasBad(String str) {
		...
		if (length == 3 && str.equals("bad")) // length is going to equal at least 3
			return true;
		else if (length >= 4) {
	...
	public String stringTimes(String str, int n) {
		...
		for (int i = 0; i < n; i++) {
			newWord = (newWord + str); // as long as condition is true keep iterating
		}
		return newWord;
	}
	...
	public String frontTimes(String str, int n) {
		...
		String newWord = "";
		 ...
		 if(str.length() < 3) {
			...
			for (int i = 0; i < n; i++) {
				newWord = (newWord + str.substring(0, 3));
			}
		 }return newWord;
	...
	public String altPairs(String str) {
		...
		// int pairs (str.substring(0,1) + str.substring(4,5) + str.substring(8, 9));
		return null;
	}
	...
	public String stringYak(String str) {
		...
		// look through a String and find the first occurrence of another String and
		// return back at what index
		// the String was found. looking for index of k
	}
