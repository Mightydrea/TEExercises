...
public class Exercises {
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		...
		Boolean weAreInTrouble = (talking && (hour < 7 || hour > 20));
	...
	public boolean makes10(int a, int b) {
		...
		boolean answerIsTrue = ((a == 10 || b == 10) || (a + b == 10));
		return answerIsTrue;
	}
	...
	public boolean or35(int n) {
		...
		if (n % 3 == 0 || n % 5 == 0) {
			return true; // not negative number >0
		}
		return false;
	}
	 ...
	 */
	public boolean cigarParty(int cigars, boolean isWeekend) { // cigars >=40 && <=60 !isWeekend
	 ...
	 */
	public int dateFashion(int you, int date) { // you > 0

		int weDidntGetATable = 0;
		int weGotTable = 2;
		int mightGetTable = 1;

		if (you <= 2 || date <= 2) {
			return weDidntGetATable;
		}
		if ((you >= 8 && you <= 10) || (date >= 8 && date <= 10)) {
			return weGotTable;
		}
		if (you >= 3 && you <= 7 || date >= 3 && date <= 7) {
			return mightGetTable;
		}
		return weDidntGetATable;
	}
	 ...
	 */
	public boolean squirrelPlay(int temp, boolean isSummer) { // temp >= 60
	...
	public int caughtSpeeding(int speed, boolean isBirthday) {
		...
		if ((!isBirthday && speed <= 60) || (isBirthday && speed <= 65)) {
			return noTicket;
		} else if ((!isBirthday && speed >= 61 && speed <= 80) || (isBirthday && speed >= 61 && speed <= 85)) {
			return smallTicket;
	...
	public boolean more20(int n) {
		...
		if ((n % 20 != 0 && n % 20 == 1) || (n % 20 != 0 && n % 20 == 2)) {
			return true;
		}
		return false;
	}
	...
	public int teenSum(int a, int b) {
		...
		if ((a >= 13 && a <= 19) || (b >= 13 && b <= 19)) {
			int theyAreNineteen = 19;
			return theyAreNineteen;
		}
		return teenSum;
	}
	...
	public boolean inOrder(int a, int b, int c, boolean bOk) {
		...
		if (bOk) // went line by line continued testing, still not fully grasping
			return c > b;
		// true/false concept with expressions,
		return b > a && c > b;
	}
