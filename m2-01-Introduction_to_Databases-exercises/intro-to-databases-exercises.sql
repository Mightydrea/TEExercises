...
-- 20. The name, continent, GNP, and average life expectancy of all countries that have an average life expectancy of at 
--least 70 years and a GNP between $1 million and $100 million dollars (3 rows)
...
SELECT (2019 - indepyear) as countryage FROM country WHERE indepyear IS NOT NULL; 
